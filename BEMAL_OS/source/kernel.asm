;BEMALOS --- The BEMAL Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE BEMALOS_VER '1.0.0'	 ;OS version number
	%DEFINE BEMALOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '----- Welcome to BEMALOS -----', 0
	os_version_msg		db 'Version ', BEMALOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', BEMALOS_VER, 0

	dialog_string_1		db 'Welcome to BEMAL Operating System', 0
